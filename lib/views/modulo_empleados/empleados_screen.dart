  ...
  void _filterEmpleados() {
    ...
    setState(() {
      empleadosFiltrados = empleados.where((empleado) {
        return (empleado['nombres']?.toString().toLowerCase() ?? '')
                .contains(query) ||
                    ...
                    child: SingleChildScrollView(
                      child: DataTable(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Text('DUI', style: TextStyle(fontWeight: FontWeight.bold))),
                          DataColumn(label: Text('NIT', style: TextStyle(fontWeight: FontWeight.bold))),
                          DataColumn(label: Text('Profesión', style: TextStyle(fontWeight: FontWeight.bold))),
                          DataColumn(label: Text('AFP', style: TextStyle(fontWeight: FontWeight.bold))),
                          DataColumn(label: Text('ISSS', style: TextStyle(fontWeight: FontWeight.bold))),
